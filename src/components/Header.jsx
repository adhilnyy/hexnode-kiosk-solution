  ...
  return (
    <header role="banner" className={`fixed group flex justify-center items-center w-full h-[69px] z-50 bg-blue hover:bg-white transition-colors duration-300 ${scrolled ? 'bg-white border border-white-tab' : 'bg-blue'}`}>
        <div className='container grid grid-cols-12'>
          ...
          <a role="link" aria-label="Start a 14-day free trial" href="https://www.hexnode.com/mobile-device-management/cloud/signup/" className='action-btn font-medium text-[15px] leading-[24px] '>14 day free trial</a>
          </div>
        </div>
    </header>
  )
